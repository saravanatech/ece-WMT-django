...
class Project(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.DO_NOTHING, db_index=True, blank=True, null=True, related_name='created_by_user')
    updated_by = models.ForeignKey(
        User, on_delete=models.DO_NOTHING, db_index=True, blank=True, null=True, related_name='updated_by_user')
